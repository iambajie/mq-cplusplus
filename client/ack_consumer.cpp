...
double GetDelayTime(string iStrMsg)
{
    ...
    int iDelMic=(tNow.tv_sec-iSec)*1000000+(tNow.tv_usec-iMic);//秒和微秒差100万
...
int main(int argc,char *argv[])
{
    ...
    if(consumerLogger.Init(pLogPath)!=Logger::SUCCESS)//日志文件  代码未用到
    {
    ...
    Consumer *pConsumer=new Consumer();//利用client.cpp 初始化消费者
